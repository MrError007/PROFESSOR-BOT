...
# PyroClient Setup 
API_ID = int(environ['API_ID', '11071959'])
API_HASH = environ['API_HASH', '1d5fcbb310ce34f4f767a1c6d5148beb']
BOT_TOKEN = environ['BOT_TOKEN', '6436852945:AAHTGp329FZWtKt_7g8Ybr6g9X7QVFGIgnU']
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001620307871').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://axubisam:Vimarsh@cluster0.ys02dxj.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp")
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://graph.org/file/a76ca4242e28aa19f82a0.jpg")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001889330926')).split()]
